 ...
 */
export const netPriceImpactAtMaxBuyVolume = (maxsUSDToSpend: number, liquidity: number, basePrice: number) => maxsUSDToSpend / liquidity - basePrice
 ...
 */
export const netPriceImpactForXsUSD = (usdToSpend: number, maxsUSDToSpend: number, netPriceImpactAtMaxBuyVolume: number) =>
 ...
 */
export const calculateAmountOfTokensForXsUSD = (usdToSpend: number, basePrice: number, maxsUSDToSpend: number, liquidity: number) => {
...
export const calculateAmountOfTokensForXsUSDOnOppositeSide = (
	...
	const priceImpactForTokensWithSkew = netPriceImpactAtMaxBuyVolume(priceOfTokensWithSkew, amountOfTokensWithSkew, basePrice)

	const priceImpactForsUSDToSpendOnTokensWithSkew = netPriceImpactForXsUSD(sUSDToSpendOnOptionsWithSkew, priceOfTokensWithSkew, priceImpactForTokensWithSkew)
...
export const fetchAmountOfTokensForXsUSDAmount = (
	...
	if (ammBalanceOfToken > 0) {
		return calculateAmountOfTokensForXsUSDOnOppositeSide(usdToSpend, basePrice, maxsUSDToSpend, liquidity, ammBalanceOfToken)
	}
