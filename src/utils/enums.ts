...
export enum COMBINED_BET_OPTIONS {
	COMBINED_WINNER_AND_TOTAL_HOME_OVER = '1O',
	COMBINED_WINNER_AND_TOTAL_HOME_UNDER = '1U',
	COMBINED_WINNER_AND_TOTAL_AWAY_OVER = '2O',
	COMBINED_WINNER_AND_TOTAL_AWAY_UNDER = '2U'
}
